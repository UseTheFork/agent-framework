...
A collection of reusable Claude Code skills. Each skill is a self-contained prompt that teaches an agent how to perform a specific workflow. Skills live in `skills/<name>/SKILL.md`.
